...
class Calculator(object):
    def __init__(self):
        ...
        layout_button = Gtk.Button("layout")
        layout_button.connect("clicked", self.do_layout)
        hbox.add(layout_button)
    ...
    def do_layout(self, widget=None, data=None):
        print("foo")
        self.nv.layout(GtkFlow.ForceLayout.new())
