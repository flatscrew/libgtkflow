...
namespace GtkFlow {
    public class DefaultNodeRenderer : NodeRenderer {
        private Pango.Layout layout;

        internal DefaultNodeRenderer(Node n) {
         ...
         */
        public override bool is_on_closebutton(Point p,
         ...
         */
        public override bool is_on_resize_handle(Point p,
                                                 Gtk.Allocation alloc,
                                                 uint border_width) {
            int x = p.x;
            int y = p.y;
         ...
         */
        public override GFlow.Dock? get_dock_on_position(Point p,
                                                    List<DockRenderer> dock_renderers,
                                                    uint border_width,
                                                    Gtk.Allocation alloc,
                                                    Gtk.Widget? title=null ) {
        ...
        public override void draw_node(Gtk.Widget w, Cairo.Context cr,
            ...
            if (child != null) {
                ...
                child.size_allocate(child_alloc.width, child_alloc.height, -1);
